 ...
 * TrainStaion encodes the stations of the network
 * A station is part of a TrainLine, which you can imagine as a doubly linked list. 
 * The class also comes with two constructors, as well as an equals method for comparing stations
 * All codes are given by the professor (No modification)

 */

public class TrainStation {
	
	private TrainStation left;	// the next station on the left
	private TrainStation right; //the next station on the right
	private boolean rightTerminal; //true if the station is at the right end of the line
	private boolean leftTerminal; //true if the station is at the left end of the line
	private String name; //the name of the station
	private TrainLine line; //the TrainLine this station belongs to
	public boolean hasConnection; //true if the train station connects to another line 
	private TrainStation transfersToStation; //the station object on the other line, if this transfer exists
	private TrainLine transfersToLine; //the line object you can transfer to at this station.
